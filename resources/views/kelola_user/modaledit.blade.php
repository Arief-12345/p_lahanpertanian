            ...
            <div class="modal-body">
                <form action="{{ url('/kelola_user/update') }}" method="POST">
                    ...
                    <input type="hidden" class="form-control" id="url_getdata" name="url_getdata"
                        value="{{ url('getdatapengguna/') }}" readonly>
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">NIP</label>
                        <input type="text" class="form-control" name="nip" id="nnip" value="{{ old('nip') }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="ppassword" name="password"
