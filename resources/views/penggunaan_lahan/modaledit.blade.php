        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ url('/penggunaan_lahan/update') }}" method="POST">
                    {{ csrf_field() }}
                    <input type="hidden" id="url_getdata" name="url_getdata" value="{{url('getdatapenggunaanlahan/')}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="float" class="form-control" name="luas_penggunaan_lahan" id="luas_penggunaan_lahan" value="{{ old('luas_penggunaan_lahan') }}"
