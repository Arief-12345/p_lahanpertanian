...
@section('aktif_kelola_data_gapoktani', 'active')
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3>Kelola Data Gapoktani</h3>
                </div>
        ...
        $('.hapus').click(function() {
            ...
            Swal.fire({
                ...
                .then((result) => {
                    console.log(result);
                    if (result.value) {
                        window.location = "/kelola_gapoktani/hapus/" + Id + "";
                    }
                });
        });
    </script>
