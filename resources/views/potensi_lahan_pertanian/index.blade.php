...
@section('aktif_kelola_data_potensi_lahan_pertanian', 'active')
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3>Kelola Data Potensi Lahan Pertanian</h3>
                </div>
                ...
                @include('potensi_lahan_pertanian/modaltambah')
                <div class="row" style="margin-top: 20px; margin-left: 10px; margin-right: 10px">
                    <table class="table" id="datatable">
                        ...
                        <tbody>
                            ...
                            @endforeach
                @include('potensi_lahan_pertanian/modaledit')
                        </tbody>
                      </table>
                </div>
                </div>
        ...
        $('.hapus').click(function() {
            ...
            Swal.fire({
                ...
                .then((result) => {
                    console.log(result);
                    if (result.value) {
                        window.location = "/kelola_data_potensi_lahan_pertanian/hapus/" + Id + "";
                    }
                });
        });
    </script>
